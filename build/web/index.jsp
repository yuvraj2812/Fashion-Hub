    ...
    <header>
        <div class="container">
            ...
            <nav class="top_nav d-flex pt-3 pb-1">
                <!-- logo -->
                <h1>
                    <a class="navbar-brand" href="index.jsp">fh
                    </a>
                </h1>
                <!-- //logo -->
                <div class="w3ls_right_nav ml-auto d-flex">
                    ...
                    <div class="nav-icon d-flex">
                        <!-- sigin and sign up -->
                        <a class="text-dark login_btn align-self-center mx-3" href="signin.jsp">
...
else
{
                        ...
                        <div class="nav-icon d-flex">
                        <!-- sigin and sign up -->
                        <a class="text-dark login_btn align-self-center mx-3" href="user.jsp">
                            <i class="far fa-user"></i>
                        </a>
                        <!-- sigin and sign up -->
                        <!-- shopping cart -->
                        ...
                        <div>
                            <right>  <a href="logout.jsp">Logout</a></right>
                        </div>
                        <!-- //shopping cart ends here -->
                    </div>
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?280</p>
                                        <p class="line-through"> ?359</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?249</p>
                                        <p class="line-through"> ?299</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?209</p>
                                        <p class="line-through"> ?269</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?199</p>
                                        <p class="line-through"> ?249</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?400</p>
                                        <p class="line-through"> ?509</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?2000</p>
                                        <p class="line-through"> ?2500</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?200</p>
                                        <p class="line-through"> ?399</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3 out_w3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?190</p>
                                        <p class="line-through"> ?250</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    <h5 class="card-title text-capitalize">Midi/Knee Length Party Dress</h5>
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?180</p>
                                        <p class="line-through"> ?250</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?210</p>
                                        <p class="line-through"> ?399</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?179</p>
                                        <p class="line-through"> ?249</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?150</p>
                                        <p class="line-through"> ?200</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?100</p>
                                        <p class="line-through"> ?250</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                        ...
                        <div class="item">
                            ...
                            <div class="card product-men p-3">
                                ...
                                <div class="card-body  py-3 px-2">
                                    ...
                                    <div class="card-text d-flex justify-content-between">
                                        <p class="text-dark font-weight-bold"> ?159</p>
                                        <p class="line-through"> ?259</p>
                                    </div>
                                </div>
                                <!-- card footer -->
                                <div class="card-footer d-flex justify-content-end">
                    ...
                    <div class="row  footer-v2grids w3-agileits">
                        ...
                        <div class="col-lg-3 col-sm-6 footer-v2grid mt-sm-0 mt-5">
                            ...
                            <div class="footer-v2grid1 row">
                                ...
                                <div class="col-8 footer-v2grid1-right p-0">
                                    <a href="blog.html">Women's fashion to make you look and feel your best!</a>
                                </div>
                            </div>
                            <div class="footer-v2grid1 row my-2">
                                ...
                                <div class="col-8 footer-v2grid1-right p-0">
                                    <a href="blog.html">Men's fashion and style advice</a>
                                </div>
                            </div>
                            <div class="footer-v2grid1 row">
                                <div class="col-4 footer-v2grid1-left">
                                ...
                                <div class="col-8 footer-v2grid1-right p-0">
                                    <a href="blog.html">Shop beautiful kids designer clothes at Childrensalon</a>
                                </div>
                            </div>
                        </div>
                        <!-- //latest posts -->
                        ...
                        <div class="col-lg-2  footer-v2grid mt-sm-0 mt-5">
                            ...
                            <ul class="w3-tag2">
                                ...
                                <li>
                                    <a href="men.html">Hub</a>
                                </li>
                                <li>
                                    <a href="shop.html">Clothes</a>
                                </li>
                                <li>
                                    <a href="boys.html">designer</a>
                                </li>
                                <li>
                                    <a href="shop.html">fashionaddict</a>
                                </li>
                                <li>
                                    <a href="women.html">catwalk</a>
                                </li>
                                <li>
                                    <a href="shop.html">beautyblogger</a>
                                </li>
                                <li>
                                    <a href="shop.html">fashionable</a>
                                </li>
                                <li>
                                    <a href="girls.html">trends</a>
                                </li>
                                <li>
                                    <a href="shop.html">style</a>
                                </li>
                                <li>
                                    <a href="shop.html">fashionshow</a>
                                </li>
                                <li>
                                    <a href="index.html">fashiography</a>
                                </li>
                                <li>
                                    <a href="shop.html">fashionista</a>
                                </li>
                                <li>
                                    <a href="men.html">look</a>
                                </li>
                                <li>
                                    <a href="shop.html">fashiondiaries</a>
                                </li>
                                <li>
                                    <a href="women.html">trend</a>
                                </li>
                            </ul>
                        </div>
                        <!-- //popular tags -->
            ...
            <div class="container-fluid py-5 footer-copy_w3ls">
                <div class="d-lg-flex justify-content-between">
                    ...
                    <div class="cpy-right align-self-center">
                        ...
                        <p>© 2018 Fashion Hub. All rights reserved.
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form action="doRegister.jsp" method="post">
                                ...
                                <div class="form-group">
                                    <label for="recipient-mobno" class="col-form-label">Mobile Number</label>
                                    <input type="tel" class="form-control" placeholder=" " name="mob_no" id="recipient-mobno" required="">
                                </div>
                                <div class="sub-w3l">

<%-- 
    Document   : signin
    Created on : 24 Mar, 2019, 2:10:29 PM
    Author     : Dell
--%>
...
.back a {color: #444444; font-size: 13px;text-decor>
    </style>
  </head>
<body id="LoginForm">
<div class="container">
   ...
   <p>Please enter your Mobile number and password</p>
    ...
    <form method="post" action="checkuser.jsp">
        ...
        <div class="form-group">
            ...
            <input type="tel" name="mob" class="form-control" id="inputMob" placeholder="Mobile Number" pattern="[0-9]{10}" required>
